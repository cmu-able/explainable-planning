...
/**
 * {@link DecAltAction} is the type of Decrease-Altitude action by a specified altitude-change level -- but does not
 * change the horizontal position.
 * 
 * @author rsukkerd
 *
 */
public class DecAltAction implements IAction {
